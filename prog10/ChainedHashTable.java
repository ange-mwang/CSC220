...
private static final int Hashindex = 0;
  ...
  public V remove (Object key) {
    ...
    // What do you do if the first element of the list has this key? (not of the table, but of the linked list) 
    ...
    } //does this return the hashIndex (is value the hashIndex) 
  ...
  private void rehash (int newCapacity) {
    // IMPLEMENT
	  ...
	  for(int i = 0; i < oldTable.length; i++) {   //TRAVERSING THE OUTSIDE ARRAY
		  for( Entry<K,V> node = oldTable[i]; node != null; node= node.next ) { //TRAVERSING THE INSIDE LINKED LIST 
