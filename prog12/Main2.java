...
public class Main2 {
	public static void main(String[] args) throws IOException {
		...
		binge.gather(browser, startingURLs);
		...
		if (false) {
                  ...
                  while (true) {
                    ...
                    for (String word : words)
                      keyWords.add(word);
                    String[] urls = binge.search(keyWords, 5);
		...
		String[] urls = binge.search(keyWords, 101);
